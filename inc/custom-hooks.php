		...
		<div class="site-branding">
			...
			if (has_custom_logo() || $mobile_logo) {
				...
				if ($mobile_logo) {
					?>
						<a href="<?php echo esc_url(home_url('/')); ?>">
							<img class="mobile-logo" src="<?php echo esc_url($mobile_logo); ?>"
				...
				if ($site_description || is_customize_preview()) {
					?>
					<p class="site-description">
						<?php echo esc_html($site_description); // phpcs:ignore.  ?>
					</p>
					<?php
				}
			}
			...
			<div class="nav-links">
				<div class="nav-previous">
					...
					if (!empty($previous_post)) {
						?>
						<span>
							<?php esc_html_e('Prev post', 'orchid-store'); ?>
						</span>
				...
				<div class="nav-next">
					...
					if (!empty($next_post)) {
						?>
						<span>
							<?php esc_html_e('Next post', 'orchid-store'); ?>
						</span>
...
if (!function_exists('orchid_store_title_breadcrumb_action')) {
	...
	function orchid_store_title_breadcrumb_action()
	{
		...
		if (orchid_store_get_option('display_page_header')) {
			?>
			<div class="os-breadcrumb-wrap" <?php
			if (has_header_image()) {
				?>
